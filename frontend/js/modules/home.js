...
import {
  ...
  renderMatchStatsPlaceholder,
  renderMatchStatsShell
} from './home/home-match-stats-view.js';
...
const renderMatchLineups = async (match, homeTeam, awayTeam) => {
  ...
  renderMatchStatsPlaceholder(homeTeam, awayTeam, homeLogoUrl, awayLogoUrl, 'Loading stats...', getShortTeamLabel);
  ...
  try {
    ...
    renderMatchStatsPanel(homeTeam, awayTeam, homeLogoUrl, awayLogoUrl, matchStats.summary, null, null, {
      clamp,
      getShortTeamLabel
    });
